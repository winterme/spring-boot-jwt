...
public class JwtHelper {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("生成的token===>" + jsonWebKey);
        Claims claims = parseJWT(jsonWebKey);
        System.out.println("解析出来的数据===>" + claims);
        String userId = AESSecretUtil.decryptToStr(claims.get("userId", String.class), SecretConstant.DATAKEY);
